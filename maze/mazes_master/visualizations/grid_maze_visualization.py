...
class MazePlot:
	...
	def save_as_image(self):
		plt.savefig("E:/DSIR/maze/static/animations/{}.png".format(self.maze_name))
		return
	...
	def animate(self):
		...
		anim.save('E:/DSIR/maze/static/animations/{}.mp4'.format(self.maze_name), writer=writer)
		return
